          ...
          children: [
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    top: 74*fem,
                    child: Container(
                      padding: EdgeInsets.fromLTRB(11*fem, 10*fem, 35.43*fem, 10*fem),
                      width: 300*fem,
                      height: 50*fem,
                      decoration: BoxDecoration (
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 11.23*fem, 0*fem),
                            width: 30*fem,
                            height: 30*fem,
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(100*fem),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Container(
                    // mingcutenotificationfill4iy (I2:93;6:81)
                  ...
                  Container(
                    // materialsymbolssearchnus (I2:93;6:85)
                  ...
                  Container(
                    // autogroupas6hvFP (9vVDauhX89AF4Vs4CuAs6H)
                  ...
                  Container(
                    // fluentpeoplecommunity16filledB (I2:93;6:77)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 49.38*fem, 0*fem),
                    width: 26.25*fem,
                    height: 26.25*fem,
                    child: Image.asset(
                      'assets/page-1/images/fluent-people-community-16-filled-rGu.png',
                      width: 26.25*fem,
                      height: 26.25*fem,
                    ),
                  ),
                  Container(
                    // uilmessageUw7 (I2:93;6:79)
                    margin: EdgeInsets.fromLTRB(0*fem, 0.01*fem, 0*fem, 0*fem),
                    width: 22*fem,
                    height: 21.99*fem,
                    child: Image.asset(
                      'assets/page-1/images/uil-message-uJ5.png',
                      width: 25*fem,
                      height: 24.99*fem,
                    ),
                  ),
