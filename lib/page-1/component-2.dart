        ...
        child: Row(
          ...
          children: [
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(0 * fem, 0 * fem, 48.75 * fem, 0 * fem),
              width: 30 * fem,
              height: 30 * fem,
              child: Image.asset(
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(0 * fem, 0 * fem, 34.75 * fem, 0 * fem),
              width: 22.5 * fem,
              height: 22.5 * fem,
              child: Image.asset(
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(0 * fem, 0 * fem, 32.88 * fem, 0 * fem),
              width: 50 * fem,
              height: 50 * fem,
              decoration: BoxDecoration(
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(0 * fem, 0 * fem, 49.38 * fem, 0 * fem),
              width: 26.25 * fem,
              height: 26.25 * fem,
              child: Image.asset(
