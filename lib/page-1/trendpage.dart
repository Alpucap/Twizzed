        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              // component2seH (1:70)
              padding:
                  EdgeInsets.fromLTRB(19 * fem, 5 * fem, 21.5 * fem, 5 * fem),
              width: double.infinity,
              height: 60 * fem,
              decoration: BoxDecoration(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    height: 22.5 * fem,
                    child: Image.asset(
                      'assets/page-1/images/material-symbols-search-2Wm.png',
                      width: 22.5 * fem,
                      height: 22.5 * fem,
                    ),
                  ),
